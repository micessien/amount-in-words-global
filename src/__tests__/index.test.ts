...
//   expect(atw.toWords('001.5', CountryCodes.GH)).toEqual('one cedis and fifty pesewas');
//   expect(atw.toWords('0.001', CountryCodes.GH)).toEqual('zero cedis and one pesewas');
// });
